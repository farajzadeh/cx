...
complete -c cx -n '__fish_seen_subcommand_from open resume shell code ask peek nudge stop rm' -a '(__cx_targets)'
complete -c cx -n '__fish_seen_subcommand_from goal' -a 'new ls show dod member pause resume done log rm'
